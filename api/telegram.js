...
function classifyGoal(text) {
  ...
  const problemWords = ['problem','issue','fix','stop','improve','overtrading','consistency','discipline','losses','drawdown','struggling','can\'t','cannot'];
  const lifestyleWords = ['freedom','free','quit','replace','retire','lifestyle','passive','full time','fulltime','full-time','independent','leave'];
